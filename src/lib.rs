...
//! standard.
//!
//! Currently, the main use case for this crate is in the [dw1000 crate], where
//! it is used to augment the hardware implementation of IEEE 802.15.4 in the
//! [DW1000]. As such, this crate focuses on the parts of IEEE 802.15.4 that are
//! required to work with that chip.
//!
...
//! [dw1000 crate]: https://github.com/braun-robotics/rust-dw1000
//! [DW1000]: https://www.decawave.com/product/dw1000-radio-ic/
//! [open an issue]: https://github.com/braun-robotics/ieee-802.15.4/issues
//! [submit a pull request]: https://github.com/braun-robotics/ieee-802.15.4/pulls
